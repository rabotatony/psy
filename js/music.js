...
const PROG={
  MIN:[[0,8,10,0],[0,5,8,10],[0,10,8,0],[0,5,7,0],[0,3,8,10]],
  MAJOR:[[0,7,9,5],[0,5,9,7],[0,9,5,7],[0,7,5,7],[0,5,7,9]],
  PHRY:[[0,1,0,10],[0,1,3,0],[0,3,10,0],[0,1,5,0]],
  HARM:[[0,8,11,0],[0,5,7,0],[0,8,5,7],[0,11,8,0]],
  DORIAN:[[0,5,0,10],[0,5,10,0],[0,10,5,0],[0,5,9,10]],
  LYDIAN:[[0,2,0,7],[0,2,4,0],[0,7,2,0],[0,2,7,4]],
  MIXO:[[0,10,5,0],[0,10,0,7],[0,5,10,0],[0,7,10,5]],
  PHRYDOM:[[0,1,0,10],[0,1,10,0],[0,1,7,0],[0,10,1,0]],
  DHARM:[[0,1,0,11],[0,1,11,0],[0,1,7,11],[0,11,1,0]],
  PDMIN:[[0,10,5,0],[0,3,5,0],[0,5,10,0],[0,7,10,5]],
};
